...
public class Tablero extends JPanel  {
	...
	public boolean Hay_Ganador(boolean[] resultado) {
		...
		else if(resultado[0] == true && resultado[1] == false && this.get_Turno() == this.JUGADOR2 ||    //Gana el jugador 1 (rojo)
				resultado[0] == false && resultado[1] == true && this.get_Turno() == this.JUGADOR1) {    //Gana el jugador 2 (azul)
